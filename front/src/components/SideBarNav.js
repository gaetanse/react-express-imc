...
export default function SideBarNav(props) {
  return (
    <div id="mySidenav" class="sidenav">
      ...
      <Menu.Item><Button>TEST</Button></Menu.Item>
      <Menu.Item><Button>TEST</Button></Menu.Item>

      <Menu.Item>gauge</Menu.Item>
